--  https://gist.github.com/BlackBulletIV/961685
...
function camera:getMousePositionX()
  return love.mouse.getX() * self.scaleX + self._x
end

function camera:getMousePositionY()
  return love.mouse.getY() * self.scaleY + self._y
end
